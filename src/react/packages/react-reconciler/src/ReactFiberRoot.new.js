...
export function createFiberRoot(
  ...
  // stateNode is any.
  // 这里创建的 HostRootFiber 是只属于 React 的根节点 root 的根部 fiber
  const uninitializedFiber = createHostRootFiber(
    tag,
    isStrictMode,
    concurrentUpdatesByDefaultOverride,
  );
  root.current = uninitializedFiber; // 原生节点 根节点 Fiber: FiberRoot 的 current 指向 HostRootFiber
