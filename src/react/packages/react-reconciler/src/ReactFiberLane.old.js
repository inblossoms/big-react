...
export function includesBlockingLane(root: FiberRoot, lanes: Lanes) {
  ...
  //! 由于包含了 DefaultLane 默认优先级，则认为这是一个阻塞渲染
  //? 为什么 DefaultLane 是阻塞渲染？
  //* 因为 DefaultLane 是 React 中默认的优先级，如果一个任务使用了 DefaultLane，那么它就会被认为是阻塞渲染的
...
export function markRootUpdated(
  ...
  //? 如果 update 是 idle 闲置状态，则不处理
  //* 因为 idle 闲置状态的 update 是在所有常规更新完成后才处理的，所以不可能阻塞 transition
